...
contract NFTmailBeacon is ERC721, AccessControl {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory svg = string(abi.encodePacked(
            ...
            '<defs>',
            '<style>@import url("https://fonts.googleapis.com/css2?family=Ayathaya&amp;display=swap");</style>',
            '</defs>',
            ...
            '<text x="256" y="140" text-anchor="middle" fill="#ffffff" ',
                'font-family="Ayathaya, monospace" font-size="28" font-weight="bold">NFTmail</text>',
            '<text x="256" y="260" text-anchor="middle" fill="', color, '" ',
                'font-family="Ayathaya, monospace" font-size="72" font-weight="bold">', tierUpper, '</text>',
            '<text x="256" y="330" text-anchor="middle" fill="#888888" ',
                'font-family="Ayathaya, monospace" font-size="16">.cast@nftmail.box</text>',
