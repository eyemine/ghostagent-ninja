...
const AGENT_ACTIONS = [
  ...
  { key: 'erc8048',       label: 'ERC-8048',      href: (n: string) => `/dashboard/erc8048?agent=${n}&collection=fakenormie`, color: 'border-cyan-500/30 bg-cyan-500/10 text-cyan-300 hover:bg-cyan-500/20' },
